...
I'm a .NET engineer who fixes weird, slow, legacy systems and makes them behave again. I use AI tools as a junior pair‑programmer for draft code, while I stay on the hook for design, integration, and production behavior.
